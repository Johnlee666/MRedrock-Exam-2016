...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.contents valueForKey:@"songname"]==nil) {
       cell.songName.text =[NSString stringWithFormat:@"%@",[self.contents objectForKey:@"songname"]];
    }
    else if ([self.contents valueForKey:@"albumname"]==nil){
        cell.songName.text = [NSString stringWithFormat:@"%@",[self.contents valueForKey:@"songname"]];
    }
    else{
